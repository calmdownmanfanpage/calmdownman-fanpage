        ...
        <li>
          ...
          <div>
            <Link to="https://www.youtube.com/@ChimChakMan_Plus">
              <img src={PlusLogo} alt="유튜브쇼츠로고" />
            </Link>
          </div>
          <div>
            <Link to="https://www.youtube.com/@ChimChakMan_Data">
              <img src={OriginalLogo} alt="원본박물관로고" />
            </Link>
          </div>
        </li>
        <li>
